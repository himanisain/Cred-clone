...
const getAndroidPrefix=()=>{
    return (
    <img src='https://web-images.credcdn.in/_next/assets/images/home-page/play-store-logo.png' className='app-rating-icon'/>
    );
  ...
  return (
    <div className='max-width flex app-rating'>
        <div className='app-rating-block flex flex-col'>
            <div className='flex'>
            <div className='app-rating-value flex-col flex'>4.8<img src='https://web-images.credcdn.in/_next/assets/images/home-page/rating-ios.png' className='app-rating-stars' />
            </div>
        ...
        <div className='app-rating-block flex flex-col'>
            <div className='flex'>
            <div className='app-rating-value flex-col flex'>4.7<img src='https://web-images.credcdn.in/_next/assets/images/home-page/rating-android.png' className='app-rating-stars' />
            </div>
            <div className='app-rating-platform'>
                play <br />store
            </div>
